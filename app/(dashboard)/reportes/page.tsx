...
const EXPORT_CARDS = [
  {
    ...
    contenido: [
      ...
      { label: 'Métricas por proveedor', detail: 'SLA respuesta/resolución/global · MTTR · T. respuesta · T. resolución · Escalados N2+ · IEI' },
      ...
      { label: 'Reincidentes', detail: 'Tiendas con 2+ incidentes · tipo frecuente · días entre caídas · tendencia NUEVO/ESTABLE/EMPEORA' },
      { label: 'Por zona geográfica', detail: 'Lima Norte · Este · Sur · Centro · Callao · Provincia — incidentes y MTTR' },
      { label: 'Reaperturas', detail: 'Total y tasa global · por proveedor con motivo (proveedor vs error agente)' },
      { label: 'Proveedor crítico', detail: 'Score de riesgo 0-100 · ranking completo por incidentes · SLA% · MTTR · IEI' },
      { label: 'Supervisores', detail: 'Incidentes · tiendas afectadas · MTTR prom · IEI total por supervisor' },
      { label: 'Clusters', detail: 'Incidentes · % del total · tiendas · MTTR · IEI por cluster A/B/C/D' },
    ],
  ...
  },
  {
    ...
    contenido: [
      { label: 'Evaluación general', detail: 'SLA% · MTTR · T. respuesta · T. resolución · Escalados N2+ · Reaperturas · IEI' },
      { label: 'Detalle por tienda', detail: 'Tipo más frecuente · SLA · MTTR · Reaperturas · IEI por tienda' },
    ],
  ...
  },
  {
    ...
    Icon: IconFueraSLA,
    contenido: [
      { label: 'Incidentes fuera de SLA', detail: 'MTTR real vs límite por tipo · Exceso en minutos · Reabierto y motivo' },
      { label: 'Motivo de incumplimiento', detail: 'N1 sin respuesta / Respuesta N1 tardía / Resolución tardía · MTTR acumulado' },
    ],
