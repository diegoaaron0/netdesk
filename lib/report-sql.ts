  ...
  return `CASE
    ...
    ELSE LEAST(
      ...
      CASE WHEN i.cont_activado_por IS NOT NULL THEN
        CASE
          WHEN i.cont_rendimiento IS NULL             THEN 0.50
          WHEN UPPER(i.cont_rendimiento) = 'EFECTIVO' THEN 0.00
          WHEN UPPER(i.cont_rendimiento) = 'PARCIAL'  THEN 0.50
          ELSE 1.00
        END
      ELSE 9.99 END,
      CASE WHEN i.mov_activado_por IS NOT NULL THEN
        CASE
          WHEN i.mov_rendimiento IS NULL             THEN 0.50
          WHEN UPPER(i.mov_rendimiento) = 'EFECTIVO' THEN 0.00
          WHEN UPPER(i.mov_rendimiento) = 'PARCIAL'  THEN 0.50
          ELSE 1.00
        END
      ELSE 9.99 END,
